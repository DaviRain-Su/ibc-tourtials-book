...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 7 | Tendermint Client | draft | IBC/TAO | instantiation | 2 | Christopher Goes <cwgoes@tendermint.com> | 2019-12-10 | 2019-12-19 |
...
The Tendermint light client uses the generalised Merkle proof format as defined in [ICS 23](https://github.com/cosmos/ibc/blob/main/spec/core/ics-023-vector-commitments).
