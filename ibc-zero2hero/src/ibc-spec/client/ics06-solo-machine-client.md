...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 6 | Solo Machine Client | draft | IBC/TAO | instantiation | 2 | Christopher Goes <cwgoes@tendermint.com> | 2019-12-09 | 2019-12-09 |

## **Synopsis**

This specification document describes a client (verification algorithm) for a solo machine with a single updateable public key which implements the [ICS 2](https://github.com/cosmos/ibc/blob/main/spec/core/ics-002-client-semantics) interface.
...
This specification must satisfy the client interface defined in [ICS 2](https://github.com/cosmos/ibc/blob/main/spec/core/ics-002-client-semantics).
...
This specification contains implementations for all of the functions defined by [ICS 2](https://github.com/cosmos/ibc/blob/main/spec/core/ics-002-client-semantics).
...
Instantiates the interface defined in [ICS 2](https://github.com/cosmos/ibc/blob/main/spec/core/ics-002-client-semantics).
