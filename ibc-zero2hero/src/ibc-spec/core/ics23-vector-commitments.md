...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 23 | Vector Commitments | draft | 2, 24 | IBC/TAO | interface | Christopher Goes <cwgoes@tendermint.com> | 2019-04-16 | 2019-08-25 |
...
The *prover* is the actor responsible for generating proofs of inclusion or non-inclusion of particular elements. Generally this will be a relayer (see [ICS 18](https://github.com/cosmos/ibc/blob/main/spec/relayer/ics-018-relayer-algorithms)).
